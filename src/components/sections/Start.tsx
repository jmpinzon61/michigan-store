                        ...
                        <div className="container-fluid position-relative">
                            ...
                            <div className="d-flex flex-row justify-content-center align-items-center">
                                <div className="banner-container" style={{ transform: 'translateY(-30px)' }}>
                                    <div className="col">
                                        <h1 className="champ-bold fs-5" style={{ marginLeft: '-170px', marginTop: '100px', width: '120px' }}>
                                        ...
                                        <p className="poppins-light" style={{ width: '140px', marginLeft: '-170px', fontSize: '12px' }}>¡Conoce Michigan's Store en un minuto!</p>
                                    </div>
                                    <div className="col">
                                        {/* <div className="center">
                                            <Link to="/prices">
                                                <button id="circle" className="d-flex justify-content-center align-items-center rounded-pill text-white poppins-light" style={{ marginLeft: '30%', marginTop: '-542px', width: '180px', height: '180px', borderRadius: '85px', backgroundColor: '#110059', color: '#ffffff', border: 'none' }}>
                                                    todos los cursos todos los cursos
                                                </button>
                                                <FontAwesomeIcon icon={faPlus} style={{ fontSize: '45px', color: '#ffffff', position: 'absolute', zIndex: 9999, marginTop: '-113px', marginLeft: '36px' }} />
                                            </Link>
                                        </div> */}
                                    </div>
                                    <div className="col">
                                        <div className="banner-image" style={{ height: '190px', width: '400px', marginTop: '-25px', marginLeft: '250px', position: 'relative' }}>
                                            <img src="/images/seccion_2.png" style={{ marginRight: '150px' }} alt="Michigan's Store" />

                                            <a href={videoUrl} style={{ position: 'absolute', top: '55%', left: '40%', transform: 'translate(-50%, -50%)', zIndex: 10 }}>
                                                <img
                                                    className="z-10"
                                                    style={{ height: '50px', width: '50px' }}
                    ...
                    <div className="d-none d-md-block d-lg-none">
                        <div className="container-fluid position-relative">
                            ...
                            <div className="d-flex flex-row justify-content-center align-items-center">
                                <div className="banner-container" style={{ transform: 'translateY(-30px)' }}>
                                    <div className="col">
                                        <h1 className="champ-bold fs-4" style={{ marginLeft: '-340px', marginTop: '650px', width: '245px' }}>
                                            Get ready to have a <span style={{ background: 'linear-gradient(90deg, #4EB4FF, #FFFFFF, #FAC99F)', WebkitBackgroundClip: 'text', color: 'transparent' }}>
                                                great time!</span>
                                        </h1>
                                        <p className="poppins-light fs-6" style={{ width: '355px', marginLeft: '-350px' }}>¡Conoce Michigan's Store en un minuto!</p>
                                    </div>
                                    <div className="col">
                                        <div className="center">
                                            <Link to="/prices">
                                                <button id="circle" className="d-flex justify-content-center align-items-center rounded-pill text-white poppins-light" style={{ marginLeft: '35%', marginTop: '-557px', width: '209px', height: '209px', borderRadius: '85px', backgroundColor: '#110059', color: '#ffffff', border: 'none' }}>
                                                    todos los cursos todos los cursos
                                                </button>
                                                <FontAwesomeIcon icon={faPlus} style={{ fontSize: '45px', color: '#ffffff', position: 'absolute', zIndex: 9999, marginTop: '-127px', marginLeft: '55px' }} />
                                            </Link>
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="banner-image" style={{ height: '220px', width: '500px', marginTop: '-715px', marginLeft: '560px', position: 'relative' }}>
                                            <img src="/images/seccion_2.png" style={{ marginRight: '150px' }} alt="Michigan's Store" />

                                            <a href={videoUrl} style={{ position: 'absolute', top: '56%', left: '44%', transform: 'translate(-50%, -50%)', zIndex: 10 }}>
                                                <img
                                                    className="z-10"
                                                    style={{ height: '50px', width: '50px' }}
                                                    src="/svgs/play-start.svg"
                            ...
                            <div className="d-flex justify-content-center align-items-center">
                                <div className="banner-container" style={{ transform: 'translateY(60px)' }}>
                                    ...
                                    <div className="col-md-4">
                                        <div className="center">
                                            <Link to="/prices">
                                                <button id="circle" className="d-flex justify-content-center align-items-center rounded-pill text-white poppins-light" style={{ marginLeft: '-2%', marginTop: '-156px', width: '209px', height: '209px', borderRadius: '85px', backgroundColor: '#110059', color: '#ffffff', border: 'none' }}>
                                                    todos los cursos todos los cursos
                                                </button>
                        ...
                        <div className="container text-center">
                            <div className="d-flex flex-column justify-content-center align-items-center">
                                <div className="row">
                                    <div className="col-5">
                                        <img
                                            style={{ width: '350px', height: '405px', marginTop: '-63px', marginRight: '-10px', position: 'relative', zIndex: 999 }}
