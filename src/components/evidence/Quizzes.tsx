...
export const Quizzes = () => {
    ...
    const handlerClosePracticeArea = (index: number) => {
        practiceManagerRef.current?.closePracticeArea(index);
    }
    ...
    return (
        <div className='bg-main-purple' style={{ overflowX: 'hidden', overflowY: 'scroll', height: '100vh' }} ref={containerRef}>
            ...
            <main className='container-fluid d-flex justify-content-center mx-auto' style={{ position: 'relative', zIndex: 6, height: '100vh', marginTop: '160px' }}>
