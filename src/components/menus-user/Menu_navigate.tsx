                    ...
                    <div className="menu-user">
                        ...
                        <div style={{position: 'absolute', zIndex: 1}}><a href="#nosotros">
                                <img style={{marginLeft: '-625px', marginTop: '50px', width: '370px', height: '170px'}}
                                    src="/svgs/Hi User Name-menu-user-2.svg" alt=""/></a></div>
                        <div style={{position: 'absolute',  zIndex: -2}}><a href="./inicio.html">
                                <img style={{marginLeft: '-405px', marginTop: '-95px', width: '310px', height: '310px'}}
                                    src="/images/section1-menu-user-2.png" alt=""/></a></div>
                        <div style={{position: 'absolute', zIndex: 3}}><a href="./nosotros.html">
                                <img style={{marginLeft: '-190px', marginTop: '180px',width: '55px', height: '55px'}}
                                    src="/images/section2-menu-user-2.png" alt=""/></a></div>
                        <div style={{position: 'absolute', zIndex: 12}}><a href="./apuntes.html">
                                <img style={{marginLeft: '425px', marginTop: '-40px', width: '30px',height: '30px'}} 
                                src="/images/section8-menu-user-2.png" alt=""/></a>
                        </div>
                        <div style={{position: 'absolute', zIndex: 11}}><a href="#avatar-menu">
                                <img style={{marginLeft: '-100px', marginTop: '-180px', width: '55px', height: '55px'}}
                                    src="/images/section3-menu-user-2.png" alt=""/></a></div>
                        <div style={{position: 'absolute', zIndex: 12}}><a href="./cursos.html">
                                <img style={{marginLeft: '-30px', marginTop: '45px', width: '160px', height: '160px'}}
                                    src="/images/section4-menu-user-2.png.png" alt="" /></a></div>
                        <div style={{position: 'absolute', zIndex: 6}}><a href="./apuntes.html">
                                <img style={{marginLeft: '275px', marginTop: '160px', width: '220px', height: '220px'}}
                                    src="/images/section5-menu-user-2.png" alt=""/></a></div>
                        <div style={{position: 'absolute', zIndex: 5}}><a href="./apuntes.html">
                                <img style={{marginLeft: '425px', marginTop: '-40px', width: '120px', height: '90px'}}
                                    src="/images/section6-menu-user-2.png" alt=""/></a></div>
                        <div style={{position: 'absolute', zIndex: 7}}><a href="./agenda.html">
                                <img style={{marginLeft: '280px', marginTop: '-210px', width: '190px', height: '150px'}}
                                    src="/images/section7-menu-user-2.png" alt=""/></a></div>
                        <div style={{position: 'absolute', zIndex: 25}}><a href="#blogs">
                                <img style={{marginLeft: '70px', marginTop: '247px', width: '50px', height: '50px'}}
                                    src="/images/Menu-user-8.png" alt=""/></a></div>
                        <div style={{position: 'absolute', zIndex: 30}}><a href="#blogs">
                                <img style={{marginLeft: '152px', marginTop: '255px', width: '60px', height: '60px'}}
                                    src="/images/Menu-user-9.png" alt=""/></a></div>
                        <div style={{position: 'absolute', zIndex: 10}}><a href="./inicio.html">
