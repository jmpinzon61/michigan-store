                ...
                <div className="dropdown d-flex align-items-center" style={{ marginTop: '-35px' }}>
                    ...
                    <div className="d-flex fs-3 bg-secondary rounded-circle  text-black  justify-content-center me-3"
                        ...
                        <ul className={`dropdown-menu dropdown-menu-end ${Opensettings ? 'show' : ''}`}>
                            <li><Link className="dropdown-item text-white poppins-light mb-2" to="/notes"
                ...
                <section className='row justify-content-between'>
                    ...
                    <div className="col-12 mx-auto" style={{ maxWidth: '900px', width: '825px' }}>
                        ...
                        <div className="row mt-5 grid gap-4 ms-4 w-100">
                            ...
                            <div className="col">
                                <Link to="/start" className="text-white d-block mb-3 poppins-light text-start"
                                    style={{ textDecoration: 'none', maxWidth: '180px', width: '180px' }}>
                                    Preguntas frecuentes
                                </Link>
                            </div>
                            <div className="col">
                                <Link to="/courses" className="text-white d-block mb-3 poppins-light text-start"
                                    style={{ textDecoration: 'none', maxWidth: '140px' }}>
                                    Cursos
                                </Link>
                            </div>
                            <div className="col">
                                <Link to="/prices" className="text-white d-block mb-3 poppins-light text-start"
                                    style={{ textDecoration: 'none', maxWidth: '140px' }}>
                                    Precios
                                </Link>
                            </div>
                            <div className="col">
                                <Link to="/blogs" className="text-white d-block mb-3 poppins-light text-start"
                                    style={{ textDecoration: 'none', maxWidth: '140px' }}>
                                    Blog
                                </Link>
                            </div>
